              ...
              <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-8">
                ...
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row items-start gap-6 mb-6">
                    ...
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#FFF6C9] border-2 border-[#0A0A0A] rounded-[6px] relative flex items-center justify-center shrink-0">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-2.5 mb-2 font-mono text-[11px] uppercase tracking-wider">
                        ...
                        <span
                          className={`inline-flex items-center gap-1 px-2 py-0.5 font-bold rounded-full text-[10px] border ${
                            isLive
                              ? "bg-[#0A0A0A] text-[#FFD100] border-[#0A0A0A]"
                              : "bg-white text-[#0A0A0A] border-[#0A0A0A]"
                          }`}
                        >
                          {isLive && <span className="w-1.5 h-1.5 rounded-full bg-[#FFD100]" />}
                          {app.status}
                        </span>
                        <span className="px-2 py-0.5 bg-white border border-[#0A0A0A] rounded-full text-[#0A0A0A] font-semibold text-[10px]">
                          {app.version}
                        </span>
                        {app.isPro && (
                          <span className="px-2 py-0.5 bg-[#FFD100] text-[#0A0A0A] font-bold border border-[#0A0A0A] rounded-[4px] text-[10px] tracking-wider">
                            PRO SPEC
                          </span>
                        )}
                      </div>
                      ...
                      <h2 className="font-display font-bold text-3xl sm:text-4xl lg:text-5xl text-[#0A0A0A] tracking-tight flex items-center gap-3">
                        <span>{app.name}</span>
                  ...
                  {/* Body Paragraph: Inter 400 with Site Gray body copy */}
                  <div className="sm:ml-26 max-w-3xl">
                    <p className="font-sans text-base text-[#6B6A63] leading-relaxed mb-6">
                      {app.description}
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-6">
                      {app.keyFeatures.slice(0, 2).map((feat, idx) => (
                        <div key={idx} className="flex items-start gap-2 font-mono text-xs text-[#0A0A0A]">
                ...
                <div className="lg:w-72 flex flex-col justify-between self-stretch pt-2 lg:pt-0 lg:border-l lg:border-[#0A0A0A]/10 lg:pl-8">
                  ...
                  <div className="flex flex-col sm:flex-row lg:flex-col gap-2.5">
                    <a
                      ...
                      className="w-full px-4 py-3 bg-[#FFD100] text-[#0A0A0A] font-display font-bold text-xs uppercase tracking-wider border-2 border-[#0A0A0A] rounded-[6px] hover:bg-[#0A0A0A] hover:text-[#FFD100] transition-colors flex items-center justify-between group/btn cursor-pointer text-center"
                    >
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2.5 bg-transparent text-[#0A0A0A] font-mono text-xs uppercase tracking-wider border-2 border-[#0A0A0A] rounded-[6px] hover:bg-[#FFF6C9] transition-colors flex items-center justify-center gap-2 cursor-pointer"
                    >
                      <FileText size={14} />
